...
export interface GenerateDeadCodeAnalysisRequest {
    idempotencyKey: string;
    file: Blob;
    minConfidence?: GenerateDeadCodeAnalysisMinConfidenceEnum;
    limit?: number;
}
...
export interface GenerateImpactAnalysisRequest {
    ...
    file: Blob;
    targets?: string;
    includeValidationFiles?: boolean;
    diff?: Blob;
}
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async generateImpactAnalysisRaw(requestParameters: GenerateImpactAnalysisRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ImpactAnalysisResponseAsync>> {
        ...
        if (requestParameters['includeValidationFiles'] != null) {
            queryParameters['includeValidationFiles'] = requestParameters['includeValidationFiles'];
        }
 ...
 * @export
 */
export const GenerateDeadCodeAnalysisMinConfidenceEnum = {
    High: 'high',
    Medium: 'medium',
    Low: 'low'
} as const;
export type GenerateDeadCodeAnalysisMinConfidenceEnum = typeof GenerateDeadCodeAnalysisMinConfidenceEnum[keyof typeof GenerateDeadCodeAnalysisMinConfidenceEnum];
